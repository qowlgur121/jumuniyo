...
@Getter
@NoArgsConstructor
public class DeliveryAreaCreateRequestDto {

    @NotBlank(message = "배달 지역명은 필수 입력 값입니다.")
    ...
    @NotNull(message = "배달 가능 여부는 필수 입력 값입니다.")
    ...
    @Builder
    public DeliveryAreaCreateRequestDto(String areaName, String detailAddress, BigDecimal deliveryFee,
    ...
    public DeliveryArea toEntity(Store store) {
        return DeliveryArea.builder()
                ...
                .deliveryTimeMinutes(this.deliveryTimeMinutes != null ? this.deliveryTimeMinutes : 30)
