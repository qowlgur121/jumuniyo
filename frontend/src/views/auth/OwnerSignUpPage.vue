        ...
        <form @submit.prevent="handleSubmit" class="signup-form">
          ...
          <div class="form-section">
            ...
            <ion-item class="form-item">
              <ion-input
                ...
                @ionBlur="validateField('storeAddress')"
              >
                <div slot="label">가게 주소</div>
              </ion-input>
            </ion-item>
          ...
          <div class="terms-section">
            ...
            <label @click="formData.agreeToTerms = !formData.agreeToTerms" class="terms-label">
              요기요 사장님 서비스 이용약관 및 개인정보처리방침에 동의합니다. <span class="required">*</span>
            </label>
          </div>
...
const validateField = (fieldName) => {
  ...
  switch (fieldName) {
    ...
    case 'storeAddress':
      if (formData.storeAddress && formData.storeAddress.length > 255) {
